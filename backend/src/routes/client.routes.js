...
const { balanceChargeSchema, clientSchema, clientUpdateSchema } = require('../validators/schemas');
...
router.post('/:id/balance-charge', auth, authorize('ADMIN', 'SELLER'), validate(balanceChargeSchema), c.chargeBalance);
